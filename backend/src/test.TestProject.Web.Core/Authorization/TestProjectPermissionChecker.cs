...
namespace test.TestProject.Common.Authorization
{
    /// <summary>
    /// TestProject Permission checker
    /// </summary>
    public class TestProjectPermissionChecker : ICustomPermissionChecker, ITestProjectPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public TestProjectPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
