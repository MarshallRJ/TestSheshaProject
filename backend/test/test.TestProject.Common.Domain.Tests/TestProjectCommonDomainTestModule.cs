...
using test.TestProject.Tests.DependencyInjection;
using Shesha;
...
namespace test.TestProject.Common.Tests
{
    [DependsOn(
    ...
    public class TestProjectCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public TestProjectCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
